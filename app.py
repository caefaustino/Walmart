...
if upload_file is not None:
    ...
    st.dataframe(df_input.head(10), column_config={'Date': st.column_config.DatetimeColumn(format='YYYY MM DD')})
    ...
    st.dataframe(functions.top10(df_input))
    st.subheader('Underperforming stores - sales below 1st quartile')
    st.dataframe(functions.bottom(df_input))
